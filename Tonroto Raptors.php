...
<body class="uk-background-image@xl uk-background-cover uk-background-muted " style="background-image: url(assets/Background-raptor.jpg); height:100vh;">
    <header>
    <div style="width: 100%;">
    ...
    <div >
        <p class="uk-h4 uk-margin-remove uk-visible@m uk-light"></p>
        <p class="uk-h4 uk-margin-remove uk-hidden@m"></p>
    </div>
</body>
